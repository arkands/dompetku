...
function updateSummary(data) {
  ...
  for (var i = 1; i < data.length; i++) {
    ...
    var tipe   = String(r[4] || 'pengeluaran').toLowerCase().trim();
  ...
  document.getElementById('saldoSekarang').textContent   = formatRupiah(saldo);
  document.getElementById('totalMasukHeader').textContent = formatRupiah(totalMasuk);
  document.getElementById('totalKeluarHeader').textContent = formatRupiah(totalKeluar);
